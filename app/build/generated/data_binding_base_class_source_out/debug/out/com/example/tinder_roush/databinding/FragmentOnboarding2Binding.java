...
public final class FragmentOnboarding2Binding implements ViewBinding {
  ...
  @NonNull
  public final ImageView onboarding2;
  ...
  private FragmentOnboarding2Binding(@NonNull LinearLayout rootView, @NonNull ImageView onboarding2,
      @NonNull TextView title2, @NonNull TextView txt2) {
  ...
  public static FragmentOnboarding2Binding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.onboarding_2;
      ImageView onboarding2 = ViewBindings.findChildViewById(rootView, id);
      if (onboarding2 == null) {
        break missingId;
      }
      ...
      return new FragmentOnboarding2Binding((LinearLayout) rootView, onboarding2, title2, txt2);
    }
